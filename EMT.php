...
class EMT_Lib
{
    ...
    public function split_number($num)
    {
...
class EMT_Tret_Space extends EMT_Tret
{
    ...
    public $domain_zones = ['ru', 'ру', 'ком', 'орг', 'уа', 'ua', 'uk', 'co', 'fr',
...
class EMT_Base
{
    ...
    public function set_enable_map($map, $disable = false, $strict = true)
    {
        ...
        if ($strict) {
            foreach ($this->trets as $tret) {
                if (in_array($this->tret_objects[$tret], $trets)) {
                    continue;
                }
...
{
    public $trets = ['EMT_Tret_Quote', 'EMT_Tret_Dash', 'EMT_Tret_Symbol', 'EMT_Tret_Punctmark', 'EMT_Tret_Number', 'EMT_Tret_Space', 'EMT_Tret_Abbr', 'EMT_Tret_Nobr', 'EMT_Tret_Date', 'EMT_Tret_OptAlign', 'EMT_Tret_Etc', 'EMT_Tret_Text'];
    ...
    public function do_setup($name, $value)
    {
        ...
        if ($name == "OptAlign.layout") {
            if ($value == "style") {
                $this->set_tag_layout(EMT_Lib::LAYOUT_STYLE);
            }

            if ($value == "class") {
                $this->set_tag_layout(EMT_Lib::LAYOUT_CLASS);
            }
